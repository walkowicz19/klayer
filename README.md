...
`index_codebase` supports Rust, Python, JavaScript, TypeScript, Go, Java, C/C++,
C#, Ruby, Kotlin, Swift, PHP, Lua, Zig, SQL, Shell, HTML, CSS, JSON, YAML, TOML,
Markdown, **COBOL** (`.cbl/.cob/.cpy`), **Natural** (`.nsp/.nse/.nsd`),
**RPG/RPGLE** (`.rpg/.rpgle/.sqlrpgle`), and **PowerScript**
(`.sru/.sra/.srd/.srw`).
